...
<head>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
...
<nav class="sticky-nav">
    ...
    <div class="container">
    	<h1 class="mt-5 mb-5">Welcome to Our Reviews!</h1>
    	<div class="card">
...
$(document).ready(function(){
    ...
    if (rating_data === 0) { // Check if no star is selected
...
$('#add_review').click(function() {
    ...
    $('#review_modal .modal-content').addClass('modal-light-blue'); // Add the light blue class
    
    // Automatically select 1 star
    rating_data = 1;
    reset_background(); // Reset all stars to default
    $('#submit_star_1').removeClass('star-light').addClass('text-warning'); // Set the first star to yellow
});
    ...
    $('#save_review').click(function(){
        ...
        else
        {
            $.ajax({
                url:"submit_rating.php",
                method:"POST",
                data: {user_rating: rating_data, user_review: user_review},
                success:function(data)
                {
                    $('#review_modal').modal('hide');
                    load_rating_data();
