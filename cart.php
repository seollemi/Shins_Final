      ...
      <tbody>
         ...
         if(mysqli_num_rows($result) > 0){
            while($fetch_cart = mysqli_fetch_assoc($result)){
                ...
                $imagePath = "./Images/Products/" . $fetch_cart['image'];
                ?>
                <tr>
                    <td><img src="<?php echo $imagePath; ?>" height="100" alt=""></td>
            <td>
            <?php 
            if (is_null($fetch_cart['size']) || $fetch_cart['size'] === 'Default') {
               echo $fetch_cart['name']; 
            } else {
               echo $fetch_cart['name'] . " - " . $fetch_cart['size']; 
            }
            ?>
         </td>
         ...
         <?php
           ...
           $Totalquantity += $fetch_cart['quantity'];  
            };
         };
         ?>
